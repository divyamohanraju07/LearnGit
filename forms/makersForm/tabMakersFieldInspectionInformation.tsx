      ...
      <div className="tab-content">
        ...
        >
          <div className="form-section">
            ...
            >
              <h3>{"Field Inspection Basic Detail"}</h3>
            </div>
          ...
          <div className="form-section">
            ...
            >
              <h3>{"Applicant Address Detail"}</h3>
            </div>
          ...
          {this.props.formValues && this.props.formValues.coBorrowerSelect && this.props.formValues.coBorrowerSelect.value !== "0" &&
            <div className="form-section">
              <div
                className={classname("form-section-head clearfix", { on: false })}
              >
                <h3>{"Co-Applicant Address Detail"}</h3>
              </div>
              <div className="form-section-content">
                <div className="flex-row">
                  <div className="form-group  add-del-button">
          ...
          {this.props.formValues && this.props.formValues.guarantorSelect && this.props.formValues.guarantorSelect.value !== "0" &&
            <div className="form-section">
              <div
                className={classname("form-section-head clearfix", { on: false })}
              >
                <h3>{"Guarantor Address Detail"}</h3>
              </div>
              <div className="form-section-content">
                <div className="flex-row">
                  <div className="form-group  add-del-button">
