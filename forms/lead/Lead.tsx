...
import config from "./leadTabInfo";
import Validator from "./leadValidator";
...
//Tab Components
import TabLeadDetails from "./tabLeadDetails";
...
let LeadDetailsReduxFormWrapper = reduxForm({
  //pass your form key
  form: "lead",
  validate: Validator,
...
const mapStateToProps = (state, props) => {
  return {
    ...
    isFormValid: isValid("lead")(state),

    //this below prop have current form values when you consume
    formValues: getFormValues("lead")(state)
  };
};

export default connect(
  mapStateToProps,
)(LeadDetailsReduxFormWrapper);
