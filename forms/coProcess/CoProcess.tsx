...
import config from "./coProcessTabInfo";
import Validator from "./coProcessValidator";
...
// import CollateralDetails from "./tabCollateral";
// import IncomeAndExpense from "./tabIncomeAndExpense";
class CoProcess extends React.Component<Props, State> {
  state = {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        >
          {this.state.activeTab === "tabCollateral" && (
            <CollateralDetails
          ...
          {this.state.activeTab === "tabIncomeAndExpense" && (
            <IncomeAndExpense
              fieldPopulator={this.props.change}
              taskInfo={this.props.taskInfo}
              formValues={this.props.formValues}
...
let coProcessReduxFormWrapper = reduxForm({
  //pass your form key
  form: "coProcess",
  validate: Validator,
...
const mapStateToProps = (state, props) => {
  return {
    ...
    isFormValid: isValid("coProcess")(state),
