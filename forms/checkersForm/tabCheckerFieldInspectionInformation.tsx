...
import { FormHeadSection, inrFormat, uploadChecker, A8V, retrieveDefaultFiles, AccountDetailsView } from "../../helpers";
...
class TabFieldInspectionInformation extends React.Component<Props, State> {
  constructor(props) {
    super(props);
    this.state = {
      /**
      ...
      if (this.props.formValues.c1Addr_selectedValue &&
        ...
        if (this.props.formValues.c1PresentAddressSameAsApplicant &&
          ...
          (this.props.formValues.c1PresentAddressSameAsApplicant &&
            this.props.formValues.c1PresentAddressSameAsApplicant.value === "No" && this.props.formValues.c1PresentAddressAadhaarSame &&
            this.props.formValues.c1PresentAddressAadhaarSame.value === "No") ||
          (this.props.formValues.c1PresentAddressSameAsApplicant &&
            this.props.formValues.c1PresentAddressSameAsApplicant.value === "Yes" && this.props.formValues.c1PresentAddressAadhaarSame &&
            this.props.formValues.c1PresentAddressAadhaarSame.value === "No")
        ) {
          information["Co-Applicant_1 Permanent Address"] = {
      ...
      if (this.props.formValues.c2Addr_selectedValue &&
        ...
        if (this.props.formValues.c2PresentAddressSameAsApplicant &&
          ...
          (this.props.formValues.c2PresentAddressSameAsApplicant &&
            this.props.formValues.c2PresentAddressSameAsApplicant.value === "No" && this.props.formValues.c2PresentAddressAadhaarSame &&
            this.props.formValues.c2PresentAddressAadhaarSame.value === "No") ||
          (this.props.formValues.c2PresentAddressSameAsApplicant &&
            this.props.formValues.c2PresentAddressSameAsApplicant.value === "Yes" && this.props.formValues.c2PresentAddressAadhaarSame &&
            this.props.formValues.c2PresentAddressAadhaarSame.value === "No")
        ) {
          information["Co-Applicant_2 Permanent Address"] = {
  ...
  render() {
    ...
    // const formValues = Object.keys(this.props.formValues);
...
const mapStateToProps = (state, props) => {
  console.log("***** credit Sanction States", state);
  return {
...
export default connect(mapStateToProps, {})(TabFieldInspectionInformation);
