...
class TabApplicantBasicInformation extends React.Component<Props, State> {
  ...
  componentDidMount = async () => {
    ...
    this.props.fieldPopulator("checker_claim", { type: 'string', value: userDetails.data.id, valueInfo: {} });
    this.props.fieldPopulator("checkerclaim_firstName", { type: 'string', value: userDetails.data.firstName, valueInfo: {} });
    this.props.fieldPopulator("checkerclaim_lastName", { type: 'string', value: userDetails.data.lastName, valueInfo: {} });
