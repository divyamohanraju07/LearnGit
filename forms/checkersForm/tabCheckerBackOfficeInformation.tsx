...
import Style from "./checkersForm.module.css";
...
class TabBackOfficeVerification extends React.Component<Props, State> {
  state = {
    ...
    FinanceChecklist: [],
    showScoreCard: false,
    tenure: this.props.formValues.FinalApprovalLoanTenure ? this.props.formValues.FinalApprovalLoanTenure.value : this.props.formValues.L2RecommendedLoanTenure ? this.props.formValues.L2RecommendedLoanTenure.value : this.props.formValues.L1RecommendedLoanTenure ? this.props.formValues.L1RecommendedLoanTenure.value : this.props.formValues.BO_RecommendedLoanTenure ? this.props.formValues.BO_RecommendedLoanTenure.value : this.props.formValues.tenureInput.value,
    amount: this.props.formValues.FinalApprovalLoanAmount ? this.props.formValues.FinalApprovalLoanAmount.value : this.props.formValues.L2RecommendedLoanAmount ? this.props.formValues.L2RecommendedLoanAmount.value : this.props.formValues.L1RecommendedLoanAmount ? this.props.formValues.L1RecommendedLoanAmount.value : this.props.formValues.BO_RecommendedLoanAmount ? this.props.formValues.BO_RecommendedLoanAmount.value : this.props.formValues.LoanAmount.value,
    showReturnTo: false,
    columnData: [
      {
        title: 'Data',
...
6) Vehicle delivery order shall be issued only from HO.`
    ...
    this.props.fieldPopulator('additionalConditions', { type: 'string', value: additionalConditions, valueInfo: {} });
  };
  ...
  mapAddressInfoChecklist = (coApplicantPrefix = "") => {
    if (this.props.formValues[`${coApplicantPrefix}PresentAddressSameAsApplicant`]) {
      if (this.props.formValues[`${coApplicantPrefix}PresentAddressSameAsApplicant`].value === 'Yes') {
        ...
        let mandatoryFields = ["HouseName", "StreetArea", "Pincode", "District", "State"];
        let addrerssCheck = [];
        for (let key in Data) {
  ...
  mapKYCImageschecklist = (coApplicantPrefix = "") => {
    try {
      ...
      // let mandatoryFields = ["panImg", "aadhaarImg","DLImg","passportImg","voterIdImage","singleKycimage"];
      let KYCImagescheck = [...this.state.KYCImageschecklist];
      for (let key in data) {
        let KYCImageData = { fieldName: "", value: {}, validation: [] };
        if (!validate.isEmpty(processVariables[key]) && processVariables[key].value !== null) {
        ...
        element.fieldValue = {
          ...
          value: processVariables[`ReferenceName_${index + 1}`]
            ? JSON.stringify({
              ...
              Type: processVariables[`ReferenceType_${index + 1}`].value
            })
            : "",
          valueInfo: {},
          fieldType: "Reference"
      ...
      <div className="form-section-content" style={{ display: "block" }}>
        <div className="flex-row">
          <div className="form-group col-xs-12 col-md-12">
            <Table columns={this.state.columnData} dataSource={JSON.parse(this.props.formValues.scoreCardData.value)} size="middle" />
          </div>
        </div>
      </div>
    </>
  ...
  handleCAMgeneration = () => {
    ...
    axios({
      ...
      method: "POST", responseType: "arraybuffer", data: this.mapCAMvalues()
    }).then(response => {
  ...
  mapCAMvalues() {
    ...
    let finalData = {};
    finalData["ApplicationDate"] = this.props.formValues.ApplicationDate ? this.props.formValues.ApplicationDate.value.slice(0, 10) : ""
    finalData["RecommendedLoanTenure"] = this.props.formValues.FinalApprovalLoanTenure ? this.props.formValues.FinalApprovalLoanTenure.value : this.props.formValues.L2RecommendedLoanTenure ? this.props.formValues.L2RecommendedLoanTenure.value : this.props.formValues.L1RecommendedLoanTenure ? this.props.formValues.L1RecommendedLoanTenure.value : this.props.formValues.BO_RecommendedLoanTenure ? this.props.formValues.BO_RecommendedLoanTenure.value : this.props.formValues.tenureInput.value;
    finalData["RecommendedLoanAmount"] = this.props.formValues.FinalApprovalLoanAmount ? this.props.formValues.FinalApprovalLoanAmount.value : this.props.formValues.L2RecommendedLoanAmount ? this.props.formValues.L2RecommendedLoanAmount.value : this.props.formValues.L1RecommendedLoanAmount ? this.props.formValues.L1RecommendedLoanAmount.value : this.props.formValues.BO_RecommendedLoanAmount ? this.props.formValues.BO_RecommendedLoanAmount.value : this.props.formValues.LoanAmount.value;
      ...
      if (Object.keys(data[parentKey]).length > 0) {
        for (let childKey in data[parentKey]) {
          ...
          if (data[parentKey][childKey]) {
            finalData[parentKey] = {
              ...finalData[parentKey], [childKey]: data[parentKey][childKey]["value"]
            }
          }
        }
      } else {
        data[parentKey] = processVariables[parentKey];
        finalData = { ...finalData, [parentKey]: data[parentKey] ? data[parentKey]["value"] : "" };
      }
    }
    return finalData;
  }
      ...
      <>
        ...
        <div className={Style.formSection}>
          <Collapse
            ...
            expandIcon={({ isActive }) =>
              <Icon type="up-circle" style={{ fontSize: "30px" }} rotate={isActive ? 180 : 0} />
            }
          >
            <Panel
              header={
              ...
              <Collapse className={Style.antSection}
                bordered={false}
                expandIconPosition={"right"}
                    ...
                    <div className="form-group col-xs-12 col-md-12">
                      <React.Fragment>
                        <div className="list-table-head">
                          <div className="row">
                            <div className="col-xs-6 col-md-3">
                              <span className="list-table-label list-table-label-pf"> field name
                                  </span>
                            </div>
                            <div className="col-xs-6 col-md-6">
                              <span className="list-table-label list-table-label-pf"> Value
                                  </span>
                            </div>
                          </div>
                        </div>
                ...
                <Panel header="Applicant Highmark Report" key="6">
                  <div className="flex-row">
                    <div className="form-group col-xs-6 col-md-4"
                      ...
                      <Anchor>
                        <Link href={this.props.formValues.CrifLink ? this.props.formValues.CrifLink.value : ""} title="Click Here to View HighMark Report" target="_blank" />
                      </Anchor>
                    </div>
                  </div>
                </Panel>
                ...
                <Panel header="Applicant CIBIL Report" key="7">
                  <div className="flex-row">
                    <div className="form-group col-xs-6 col-md-4"
                      style={{ paddingBottom: "15px" }}>
                      <Anchor>
                        <Link href={this.props.formValues.CibilLink ? this.props.formValues.CibilLink.value : ""} title="Click Here to View CIBIL Report" target="_blank" />
                      </Anchor>
                    </div>
                  </div>
                </Panel>
                  ...
                  <Panel header="Co-Applicant 1 Highmark Report" key="4">
                    <div className="flex-row">
                      <div className="form-group col-xs-6 col-md-4"
                        style={{ paddingBottom: "15px" }}>
                        <Anchor>
                          <Link href={this.props.formValues.c1CrifLink ? this.props.formValues.c1CrifLink.value : ""} title="Click Here to View HighMark Report" target="_blank" />
                        </Anchor>
                      </div>
                    </div>
                  </Panel>
                  ...
                  <Panel header="Co-Applicant 1 CIBIL Report" key="5">
                    <div className="flex-row">
                      <div className="form-group col-xs-6 col-md-4"
                        style={{ paddingBottom: "15px" }}>
                        <Anchor>
                          <Link href={this.props.formValues.c1CibilLink ? this.props.formValues.c1CibilLink.value : ""} title="Click Here to View CIBIL Report" target="_blank" />
                        </Anchor>
                      </div>
                    </div>
                  </Panel>
                  ...
                  <Panel header="Co-Applicant 2 Highmark Report" key="4">
                    <div className="flex-row">
                      <div className="form-group col-xs-6 col-md-4"
                        style={{ paddingBottom: "15px" }}>
                        <Anchor>
                          <Link href={this.props.formValues.c2CrifLink ? this.props.formValues.c2CrifLink.value : ""} title="Click Here to View HighMark Report" target="_blank" />
                        </Anchor>
                      </div>
                    </div>
                  </Panel>
                  ...
                  <Panel header="Co-Applicant 2 CIBIL Report" key="5">
                    <div className="flex-row">
                      <div className="form-group col-xs-6 col-md-4"
                        style={{ paddingBottom: "15px" }}>
                        <Anchor>
                          <Link href={this.props.formValues.c2CibilLink ? this.props.formValues.c2CibilLink.value : ""} title="Click Here to View CIBIL Report" target="_blank" />
                        </Anchor>
                      </div>
                    </div>
                  </Panel>
                  ...
                  <Panel header="Co-Applicant 3 Highmark Report" key="4">
                    <div className="flex-row">
                      <div className="form-group col-xs-6 col-md-4"
                        style={{ paddingBottom: "15px" }}>
                        <Anchor>
                          <Link href={this.props.formValues.c3CrifLink ? this.props.formValues.c3CrifLink.value : ""} title="Click Here to View HighMark Report" target="_blank" />
                        </Anchor>
                      </div>
                    </div>
                  </Panel>
                  ...
                  <Panel header="Co-Applicant 3 CIBIL Report" key="5">
                    <div className="flex-row">
                      <div className="form-group col-xs-6 col-md-4"
                        style={{ paddingBottom: "15px" }}>
                        <Anchor>
                          <Link href={this.props.formValues.c3CibilLink ? this.props.formValues.c3CibilLink.value : ""} title="Click Here to View CIBIL Report" target="_blank" />
                        </Anchor>
                      </div>
                    </div>
                  </Panel>
                  ...
                  <Panel header="Co-Applicant 4 Highmark Report" key="4">
                    <div className="flex-row">
                      <div className="form-group col-xs-6 col-md-4"
                        style={{ paddingBottom: "15px" }}>
                        <Anchor>
                          <Link href={this.props.formValues.c4CrifLink ? this.props.formValues.c4CrifLink.value : ""} title="Click Here to View HighMark Report" target="_blank" />
                        </Anchor>
                      </div>
                    </div>
                  </Panel>
                  ...
                  <Panel header="Co-Applicant 4 CIBIL Report" key="5">
                    <div className="flex-row">
                      <div className="form-group col-xs-6 col-md-4"
                        style={{ paddingBottom: "15px" }}>
                        <Anchor>
                          <Link href={this.props.formValues.c4CibilLink ? this.props.formValues.c4CibilLink.value : ""} title="Click Here to View CIBIL Report" target="_blank" />
                        </Anchor>
                      </div>
                    </div>
                  </Panel>
                    ...
                    <div className="flex-row">
                      <div className="form-group col-xs-12 col-md-12">
                        <React.Fragment>
                          ...
                          {!validate.isEmpty(this.state.g1ApplicantChecklist) &&
                  ...
                  <Panel header="Guarantor_1 Highmark Report" key="4">
                    <div className="flex-row">
                      <div className="form-group col-xs-6 col-md-4"
                        style={{ paddingBottom: "15px" }}>
                        <Anchor>
                          <Link href={this.props.formValues.g1CrifLink ? this.props.formValues.g1CrifLink.value : ""} title="Click Here to View HighMark Report" target="_blank" />
                        </Anchor>
                      </div>
                    </div>
                  </Panel>
                  ...
                  <Panel header="Guarantor_1 CIBIL Report" key="5">
                    <div className="flex-row">
                      <div className="form-group col-xs-6 col-md-4"
                        style={{ paddingBottom: "15px" }}>
                        <Anchor>
                          <Link href={this.props.formValues.g1CibilLink ? this.props.formValues.g1CibilLink.value : ""} title="Click Here to View CIBIL Report" target="_blank" />
                        </Anchor>
                      </div>
                    </div>
                  </Panel>
                    ...
                    <div className="flex-row">
                      <div className="form-group col-xs-12 col-md-12">
                        <React.Fragment>
                          ...
                          {!validate.isEmpty(this.state.g2ApplicantChecklist) &&
                  ...
                  <Panel header="Guarantor_2 Highmark Report" key="4">
                    <div className="flex-row">
                      <div className="form-group col-xs-6 col-md-4"
                        style={{ paddingBottom: "15px" }}>
                        <Anchor>
                          <Link href={this.props.formValues.g2CrifLink ? this.props.formValues.g2CrifLink.value : ""} title="Click Here to View HighMark Report" target="_blank" />
                        </Anchor>
                      </div>
                    </div>
                  </Panel>
                  ...
                  <Panel header="Guarantor_2 CIBIL Report" key="5">
                    <div className="flex-row">
                      <div className="form-group col-xs-6 col-md-4"
                        style={{ paddingBottom: "15px" }}>
                        <Anchor>
                          <Link href={this.props.formValues.g2CibilLink ? this.props.formValues.g2CibilLink.value : ""} title="Click Here to View CIBIL Report" target="_blank" />
                        </Anchor>
                      </div>
                    </div>
                  </Panel>
          ...
          <div className={Style.formSection}>
            <Collapse className={Style.antSection}
              ...
              <Panel header={
                    ...
                    <div className="flex-row">
                      <div className="form-group col-xs-6 col-md-4">
                        <Field
                          ...
                          className="form-control-coustom"
                          validate={[
                            A8V.required({ errorMsg: "Applicant Occupation Type is required" })
                          ]}
                        />
                      </div>
                      <div className="form-group col-xs-6 col-md-4">
                        ...
                        <div className="flex-row">
                          <div className="form-group col-xs-6 col-md-4">
                            <Field
                              ...
                              className="form-control-coustom"
                              validate={[
                                A8V.required({ errorMsg: "Co-Applicant Occupation Type is required" })
                              ]}
                            />
                          </div>
                          <div className="form-group col-xs-6 col-md-4">
                            <Field
                              ...
                              className="form-control-coustom"
                              validate={[
                                A8V.required({ errorMsg: "Co-Applicant1 Occupation Type is required" })
                              ]}
                            />
                          </div>
                        </div>
                        ...
                        <div className="flex-row">
                          <div className="form-group col-xs-6 col-md-4">
                            <Field
                              ...
                              className="form-control-coustom"
                              validate={[
                                A8V.required({ errorMsg: "Co-Applicant2 Occupation Type is required" })
                              ]}
                            />
                          </div>
                          <div className="form-group col-xs-6 col-md-4">
                        ...
                        <div className="flex-row">
                          <div className="form-group col-xs-6 col-md-4">
                            <Field
                              ...
                              className="form-control-coustom"
                              validate={[
                                A8V.required({ errorMsg: "Co-Applicant3 Occupation Type is required" })
                              ]}
                            />
                          </div>
                          <div className="form-group col-xs-6 col-md-4">
                        ...
                        <div className="flex-row">
                          <div className="form-group col-xs-6 col-md-4">
                            <Field
                              ...
                              className="form-control-coustom"
                              validate={[
                                A8V.required({ errorMsg: "Co-Applicant4 Occupation Type is required" })
                              ]}
                            />
                          </div>
                          <div className="form-group col-xs-6 col-md-4">
                    ...
                    <div className="flex-row">
                      ...
                      <div className="form-group col-xs-6 col-md-4">
                        <Field
                          ...
                          className="form-control-coustom"
                          validate={[
                            A8V.required({ errorMsg: "Financial Obligation is required" })
                          ]}
                        />
                      </div>
                      <div className="form-group col-xs-6 col-md-4">
                    ...
                    <div className="flex-row">
                        ...
                        >
                          <Descriptions.Item label="Industry Experience">
                            <EditableField
                              ...
                              value={this.props.formValues.IndustryExperience &&
                                this.props.formValues.IndustryExperience.value} />
                          </Descriptions.Item>
                          <Descriptions.Item label="Credit History">
                            <EditableField
                              name={"CreditHistory"}
                              value={this.props.formValues.CreditHistory &&
                          ...
                          <Descriptions.Item label="Reference Done">
                            <EditableField
                              name={"ReferenceDone"}
                              value={this.props.formValues.ReferenceDone &&
                          ...
                          <Descriptions.Item label="Negatives">
                            <EditableField
                              name={"Negatives"}
                              value={this.props.formValues.Negatives &&
                          ...
                          <Descriptions.Item label="Mitigants">
                            <EditableField
                              name={"Mitigants"}
                              value={this.props.formValues.Mitigants &&
                          ...
                          <Descriptions.Item label="Cash Flow">
                            <EditableField
                              name={"CashFlow"}
                              value={this.props.formValues.CashFlow &&
                          ...
                          <Descriptions.Item label="Utilization of Loan">
                            <EditableField
                              ...
                              value={this.props.formValues.utilizationofLoan && this.props.formValues.utilizationofLoan.value}
                            />
                          </Descriptions.Item>
                          <Descriptions.Item label="Additional Conditions">
                            <EditableField
                              name={"additionalConditions"}
                              value={this.props.formValues.additionalConditions &&
                                this.props.formValues.additionalConditions.value}
                            />
                          </Descriptions.Item>
                        </Descriptions>
                      </div>
                      <div className="form-group col-xs-6 col-md-4" style={{ marginTop: "10px" }}>
                        <Field
                          label="Loan Scheme"
                          name="LoanPurpose"
                          component={TextBox}
                      ...
                      <div className="form-group col-xs-6 col-md-4">
                        <Field
                          ...
                          validate={[
                            A8V.required({
                              errorMsg: "Expected Loan Tenure is required"
                            })
                          ]}
                        />
                      </div>
                      <div className="form-group col-xs-6 col-md-4" style={{ marginTop: "10px" }}>
                        <IntegerStep
                          ...
                          min={25000}
                          max={this.props.formValues.FinalApprovalLoanAmount ? this.props.formValues.FinalApprovalLoanAmount.value : this.props.formValues.L2RecommendedLoanAmount ? this.props.formValues.L2RecommendedLoanAmount.value : this.props.formValues.L1RecommendedLoanAmount ? this.props.formValues.L1RecommendedLoanAmount.value : this.props.formValues.BO_RecommendedLoanAmount ? this.props.formValues.BO_RecommendedLoanAmount.value : this.props.formValues.LoanAmount.value}
                          value={amount}
                          step={1000}
                      ...
                      <div className="form-group col-xs-6 col-md-4" style={{ marginTop: "10px" }}>
                        <IntegerStep
                          ...
                          min={12}
                          max={this.props.formValues.FinalApprovalLoanTenure ? this.props.formValues.FinalApprovalLoanTenure.value : this.props.formValues.L2RecommendedLoanTenure ? this.props.formValues.L2RecommendedLoanTenure.value : this.props.formValues.L1RecommendedLoanTenure ? this.props.formValues.L1RecommendedLoanTenure.value : this.props.formValues.BO_RecommendedLoanTenure ? this.props.formValues.BO_RecommendedLoanTenure.value : this.props.formValues.tenureInput.value}
                          value={tenure}
                          step={1.00}
                ...
                {this.props.formValues.finalCreditScore && this.props.formValues.finalCreditScore.value && this.props.formValues.CreditScoreGrade && this.props.formValues.CreditScoreGrade.value && this.props.formValues.LevelofRisk && this.props.formValues.LevelofRisk.value &&
                  <Collapse
                    className={Style.antSection}
                    bordered={true}
                    expandIconPosition={"right"}
                        ...
                        <div className="form-section">
                          ...
                          >
                            <div style={{ display: "flex" }}>
                              ...
                              <Scorecards
                                title={"Credit Grade"}
                                Score={this.props.formValues.CreditScoreGrade.value}
                              />
                              <Scorecards
                                title={"Level of Risk"}
                              ...
                              <div style={{
                                ...
                                <Icon type="solution"
                                  style={{ fontSize: "48px" }}
                                  onClick={() => this.setState({ showScoreCard: !this.state.showScoreCard })}
                                />
                              </div>
                            </div>
