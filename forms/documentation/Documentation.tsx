...
import config from "./documentationTabInfo";
import Validator from "./documentationValidator";
...
//Tab Components
import TabDocumentation from "./tabDocumentation";
type Props = {
  env: any;
  ipc: any;
  formValues: any;
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        >
          {this.state.activeTab === "documentation" && (
            <TabDocumentation
...
let DocumentationReduxFormWrapper = reduxForm({
  //pass your form key
  form: "documentation",
  validate: Validator,
...
const mapStateToProps = (state, props) => {
  return {
    ...
    isFormValid: isValid("documentation")(state),
