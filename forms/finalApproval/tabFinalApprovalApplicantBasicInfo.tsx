...
class TabApplicantBasicInformation extends React.Component<Props, State> {
  ...
  componentDidMount = async () => {
    ...
    this.props.fieldPopulator("FA_claim", { type: 'string', value: userDetails.data.id, valueInfo: {} });
    this.props.fieldPopulator("FAclaim_firstName", { type: 'string', value: userDetails.data.firstName, valueInfo: {} });
    this.props.fieldPopulator("FAclaim_lastName", { type: 'string', value: userDetails.data.lastName, valueInfo: {} });
  }
  handleReturn = () => {
