...
class TabCollateralInformation extends React.Component<Props, State> {
  ...
  handleCAMgeneration = () => {
    ...
    axios({ url: `${Config.apiUrl}/v1/camReport`, method: "POST", responseType: "arraybuffer", data: this.mapCAMvalues() }).then(response => {
...
const mapStateToProps = (state, props) => {
  console.log("******** state values for L1 creditSanction collateral********", state);
  return {
