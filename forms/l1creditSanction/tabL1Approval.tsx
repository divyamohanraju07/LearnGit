...
class TabApproval extends React.Component<Props, State> {
  constructor(props: Props) {
    ...
    this.state = {
       ...
       */
      sectionValidator: {
        L1OfficerComments: ['L1OfficerComments', 'l1Status', 'l1returnTO'],
      },
      amount: this.props.formValues.BO_RecommendedLoanAmount
        ? this.props.formValues.BO_RecommendedLoanAmount.value
        : this.props.formValues.LoanAmount.value,
      tenure: this.props.formValues.BO_RecommendedLoanTenure
  ...
  componentDidMount = () => {
    ...
    if (formvalues.BO_RecommendedLoanAmount) {
    ...
    if (formvalues.BO_RecommendedLoanTenure) {
    ...
    if (
      ...
      this.props.fieldPopulator('L1OfficerComments', {
        type: 'String',
        value: '',
      })
      this.props.fieldPopulator('l1Status', { type: 'String', value: '' })
    }
  }
  ...
  handleInsuranceChange = () => {
    ...
    let insuranceChargeConfig = {
      ...
      data: {
        variables: {
          ...
          tenureInput: {
            value: this.props.formValues.BO_RecommendedLoanTenure
              ? this.props.formValues.BO_RecommendedLoanTenure.value
              : this.props.formValues.tenureInput.value,
            type: 'Integer',
          },
    ...
    axios(insuranceChargeConfig).then((response) => {
      ...
      let loanAmount = this.props.formValues.BO_RecommendedLoanAmount
        ? this.props.formValues.BO_RecommendedLoanAmount.value
        : this.props.formValues.LoanAmount.value
  ...
  handleRecommendedloanAmount = (e) => {
    ...
    if (e !== 0) {
      this.props.fieldPopulator('L1RecommendedLoanAmount', {
        type: 'String',
        value: e,
      })
      this.props.fieldPopulator('L1RecommendedLoanAmount_inwords', {
        type: 'String',
  ...
  handleRecommendedTenure = (e) => {
    ...
    if (e !== 0) {
      this.props.fieldPopulator('L1RecommendedLoanTenure', {
        type: 'String',
        value: e,
      })
    } else {
  ...
  handleApproveClick = () => {
    ...
    if (LoanAmount <= 100000) {
      this.props.fieldPopulator('approveLevel', { type: 'String', value: 1 })
    }
    if ((LoanAmount > 100000 && LoanAmount <= 200000) || LoanAmount > 200000) {
      this.props.fieldPopulator('approveLevel', { type: 'String', value: 2 })
    }
    this.setState({ showReturnTo: false })
    this.props.fieldPopulator('l1Status', {
      type: 'String',
      value: 'Approved',
    })
    this.props.fieldPopulator('L1ApprovalDate', {
      type: 'String',
    ...
    return (
      <div className="tab-content">
        ...
        >
          ...
          <div className="form-section">
            <FormHeadSection
              sectionLabel="Level-1 Credit Officer Comments"
              sectionKey="L1OfficerComments"
            ...
            <div className="form-section-content">
              <div className="flex-row">
                ...
                >
                  <IntegerStep
                    label="L1 Recommended Loan Amount"
                    min={25000}
                    max={
                ...
                >
                  <IntegerStep
                    label=" L1 Recommended Loan Tenure"
                    min={24}
                    max={
                ...
                <div className="form-group col-xs-6 col-md-4">
                  ...
                  <Field
                    ...
                    className="form-control-custom"
                    validate={[
                      A8V.required({ errorMsg: 'l1Status is required' }),
                    ]}
                  />
                ...
                {this.state.showReturnTo && (
                  <div className="form-group col-xs-6 col-md-4">
                    <Field
                      ...
                      className="a8Select"
                      validate={[
                        A8V.required({ errorMsg: 'l1returnTO is required' }),
                      ]}
                    >
