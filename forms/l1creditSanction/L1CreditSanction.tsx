...
import config from "./l1creditSanctionTabInfo";
import Validator from "./l1creditSanctionValidator";
...
//Tab Components
import TabApplicantBasicInformation from "./tabL1ApplicantBasicInfo";
import TabBackOfficeInformation from "./tabL1BackOfficeInformation";
import TabFieldInspectionInformation from "./tabL1FieldInspectionInformation";
import TabApproval from "./tabL1Approval";
...
class l1CreditSanction extends React.Component<Props, State> {
  state = {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        >
          {this.state.activeTab === "tabL1ApplicantBasicInfo" && (
            <TabApplicantBasicInformation
              fieldPopulator={this.props.change}
              taskInfo={this.props.taskInfo}
            />
          )}
          {/* {this.state.activeTab === "tabL1CollateralInformation" && (
          ...
          {this.state.activeTab === "tabL1BackOfficeInformation" && (
          ...
          {this.state.activeTab === "tabL1FieldInspectionInformation" && (
          ...
          {this.state.activeTab === "tabL1Approval" && (
            <TabApproval
              fieldPopulator={this.props.change}
              taskInfo={this.props.taskInfo}
              formValues={this.props.formValues}
...
let l1CreditSanctionReduxFormWrapper = reduxForm({
  //pass your form key
  form: "l1creditSanction",
  validate: Validator,
...
const mapStateToProps = (state, props) => {
  return {
    ...
    isFormValid: isValid("l1creditSanction")(state),
...
export default connect(
  mapStateToProps,
)(l1CreditSanctionReduxFormWrapper);
