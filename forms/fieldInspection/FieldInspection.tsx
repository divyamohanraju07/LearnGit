...
import config from "./fieldInspectionTabInfo";
import Validator from "./fieldInspectionValidator";
...
import {
  extractInitialValues, Config, formatValues,
  // handleFormWatcher
} from "../../helpers";
...
import TabFieldInspection from "./tabFieldInspection";
type Props = {
  env: any;
  ipc: any;
  formValues: any;
...
class Inspect extends React.Component<Props, State> {
  state = {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        >
          {this.state.activeTab === "tabFieldInspection" && (
            <TabFieldInspection
...
let InspectReduxFormWrapper = reduxForm({
  //pass your form key
  form: "fieldInspection",
  validate: Validator,
...
const mapStateToProps = (state, props) => {
  return {
    ...
    isFormValid: isValid("fieldInspection")(state),
