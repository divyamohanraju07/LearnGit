...
import config from "./finalDisbursementTabInfo";
import Validator from "./finalDisbursementValidator";
...
//Tab Components
import TabFinalDisbursement from "./tabFinalDisbursement";
...
class FinalDisbursement extends React.Component<Props, State> {
    state = {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                >
                    {this.state.activeTab === "tabFinalDisbursement" && (
                        <TabFinalDisbursement
...
let FinalDisbursementReduxFormWrapper = reduxForm({
    //pass your form key
    form: "finalDisbursement",
    validate: Validator,
    asyncChangeFields: ["LoanAmount"],
...
const mapStateToProps = (state, props) => {
    return {
        ...
        isFormValid: isValid("finalDisbursement")(state),

        //this below prop have current form values when you consume
        formValues: getFormValues("finalDisbursement")(state)
    };
};

export default connect(
    mapStateToProps,
)(FinalDisbursementReduxFormWrapper);
